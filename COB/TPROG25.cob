...
000200 PROGRAM-ID.    TPROG23.
000300 AUTHOR.        COMPUWARE ISPW TRAINING 1-2-3.
000400 DATE-WRITTEN.  JANUARY 24TH, 1996.
000500 DATE-COMPILED.
000600
000700********************************************************
000800* THIS PROGRAM IS A TRAINING PROGRAM 1133
000900*      WITH A LINK TO TSUBR23
001000*
001100*      AND COPYLIBS   TCPYA23   (HEADER)
001200*                     TCPYB23   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'TSUBR23' USING PASS-ME-AROUND.
009000
...
013700     CALL 'TSUBR23' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TSUBR23' USING PASS-ME-AROUND.
