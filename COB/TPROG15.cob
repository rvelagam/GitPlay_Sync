...
000200 PROGRAM-ID.    TPROG13.
000300 AUTHOR.        COMPUWARE ISPW TRAINING.
000400 DATE-WRITTEN.  JANUARY 24TH, 1996.
000500 DATE-COMPILED.
000600
000700********************************************************
000800* THIS PROGRAM IS A TRAINING PROGRAMxxxstg2sss
000900*      WITH A LINK TO TSUBR13
001000*
001100*      AND COPYLIBS   TCPYA13   (HEADER)
001200*                     TCPYB13   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'TSUBR13' USING PASS-ME-AROUND.
009000
...
013700     CALL 'TSUBR13' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TSUBR13' USING PASS-ME-AROUND.
