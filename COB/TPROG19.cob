...
000900*      WITH A LINK TO TSUBR17
001000*
001100*      AND COPYLIBS   TCPYA17   (HEADER)
001200*                     TCPYB17   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'TSUBR17' USING PASS-ME-AROUND.
009000
...
013700     CALL 'TSUBR17' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TSUBR17' USING PASS-ME-AROUND.
