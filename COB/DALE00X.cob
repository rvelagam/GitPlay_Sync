...
000900*      WITH A LINK TO DALESTST
001000*
...
008900     CALL 'DALESTST' USING PASS-ME-AROUND.
009000
...
013700     CALL 'DALESTST' USING PASS-ME-AROUND.
013800
...
014400        CALL 'DALESTST' USING PASS-ME-AROUND.
