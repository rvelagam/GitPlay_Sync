...
000200 PROGRAM-ID.    TPROG20.
000300 AUTHOR.        COMPUWARE ISPW TRAINING1.
000400 DATE-WRITTEN.  JANUARY 24TH, 1996.
000500 DATE-COMPILED.
000600
000700********************************************************
000800* THIS PROGRAM IS A TRAINING PROGRAM 1130
000900*      WITH A LINK TO TSUBR20
001000*
001100*      AND COPYLIBS   TCPYA20   (HEADER)
001200*                     TCPYB20   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'TSUBR20' USING PASS-ME-AROUND.
009000
...
013700     CALL 'TSUBR20' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TSUBR20' USING PASS-ME-AROUND.
