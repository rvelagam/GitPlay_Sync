...
000900*      WITH A LINK TO HZSSUB2
001000*
001100*      AND COPYLIBS   HZSCPYA2   (HEADER)
001200*                     HZSCPYB2   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'HZSSUB2' USING PASS-ME-AROUND.
009000
...
013700     CALL 'HZSSUB2' USING PASS-ME-AROUND.
013800
...
014400        CALL 'HZSSUB2' USING PASS-ME-AROUND.
