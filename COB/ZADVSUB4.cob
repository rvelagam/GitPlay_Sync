...
000200 PROGRAM-ID.    ZADVSUB2.
000300 AUTHOR.        COMPUWARE ISPW TRAINING.
000400 DATE-WRITTEN.  JANUARY 24TH, 1996-3.
000500 DATE-COMPILED.
000600
000700********************************************************
000800* THIS PROGRAM IS A TRAINING PROGRAM
000900*      CALLED FROM    ZADVCOB2
001000*      WITH COPYLIB   ZADVCB02(LINKAGE AREA)
001100* ======================================================
001200*  ISPW (TM)
