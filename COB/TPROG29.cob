...
000900*      WITH A LINK TO TSUBR27
001000*
001100*      AND COPYLIBS   TCPYA27   (HEADER)
001200*                     TCPYB27   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'TSUBR27' USING PASS-ME-AROUND.
009000
...
013700     CALL 'TSUBR27' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TSUBR27' USING PASS-ME-AROUND.
