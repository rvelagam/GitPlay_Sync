...
000900*      WITH A LINK TO TIMSUB2
001000* ü âäàáãå ¦¦¦¦¦¦¦¦¦ ]]]]]]]
001100*      AND COPYLIBS   TIMCPYA2   (HEADER)
001200*                     TIMCPYB2   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'TIMSUB2' USING PASS-ME-AROUND.
009000
...
013700     CALL 'TIMSUB2' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TIMSUB2' USING PASS-ME-AROUND.
