...
000900*      WITH A LINK TO TSUBR28
001000*
001100*      AND COPYLIBS   TCPYA28   (HEADER)
001200*                     TCPYB28   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'TSUBR28' USING PASS-ME-AROUND.
009000
...
013700     CALL 'TSUBR28' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TSUBR28' USING PASS-ME-AROUND.
