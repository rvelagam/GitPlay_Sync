...
000200 PROGRAM-ID.    TIMPRG1.
000300 AUTHOR.        COMPUWARE ISPW TRAINING.
000400 DATE-WRITTEN.  JANUARY 24TH, 1996.
000500 DATE-COMPILED.
000600
000700********************************************************
000800* THIS PROGRAM IS A TRAINING PROGRAM         HOST NEW
000900*      WITH A LINK TO TIMSUB1
001000*
001100*      AND COPYLIBS   TIMCPYA1   (HEADER)
001200*                     TIMCPYB1   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
001800*  Ã¥ Ã¼ Ã¢Ã¤Ã Ã¡Ã£Ã¥ Â¦Â¦Â¦Â¦Â¦Â¦
001900* ======================================================
...
008900     CALL 'TIMSUB1' USING PASS-ME-AROUND.
009000
...
013700     CALL 'TIMSUB1' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TIMSUB1' USING PASS-ME-AROUND.
