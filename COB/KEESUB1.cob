...
000900*      WITH A LINK TO KEESUB2
001000*
001100*      AND COPYLIBS   KEECPYA2   (HEADER)
001200*                     KEECPYB2   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'KEESUB2' USING PASS-ME-AROUND.
009000
...
013700     CALL 'KEESUB2' USING PASS-ME-AROUND.
013800
...
014400        CALL 'KEESUB2' USING PASS-ME-AROUND.
