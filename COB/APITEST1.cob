...
000900*      WITH A LINK TO APISUB1
001000*
001100*      AND COPYLIBS   APICPYA1   (HEADER)
001200*                     APICPYB1   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'APISUB1' USING PASS-ME-AROUND.
009000
...
013700     CALL 'APISUB1' USING PASS-ME-AROUND.
013800
...
014400        CALL 'APISUB1' USING PASS-ME-AROUND.
