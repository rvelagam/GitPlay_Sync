      ...
      ******************************************************************
       ...
       01  DATE-FIELDS REDEFINES TODAYS-DATE.
           ...
           05  DATE-MM                PIC 9(2).
           05  DATE-DD                PIC 9(2).
       01  SORT-DOC-NUM                  COMP  PIC S9(13) VALUE 0.
       01  SORT-DOC-NUM2                 COMP  PIC S9(5) VALUE 0.
********
...
*********
       ...
       0000-MAINLINE.
           MOVE -8 TO SORT-DOC-NUM2.
           MOVE -8431 TO SORT-DOC-NUM.
           MOVE -8431809994008 TO SORT-DOC-NUM.
           PERFORM 9000-OPEN.
