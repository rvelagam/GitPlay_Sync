...
000200 PROGRAM-ID.    DALE001.
000300 AUTHOR.        COMPUWARE ISPW TRAINING.
000400 DATE-WRITTEN.  DECEMBER 3RD, 2021.
000500 DATE-COMPILED.
000600
000700********************************************************
000800* THIS PROGRAM IS A TRAINING PROGRAM
000900*      WITH A LINK TO DALES01
001000*
001100*      AND COPYLIBS   TCPYA22   (HEADER)
001200*                     TCPYB22   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'DALES01' USING PASS-ME-AROUND.
009000
...
013700     CALL 'DALES01' USING PASS-ME-AROUND.
013800
...
014400        CALL 'DALES01' USING PASS-ME-AROUND.
