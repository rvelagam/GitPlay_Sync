...
000200 PROGRAM-ID.    TPROG14.
000300 AUTHOR.        COMPUWARE ISPW TRAINING.
000400 DATE-WRITTEN.  JANUARY 24TH, 1996.
000500 DATE-COMPILED.
000600
000700********************************************************
000800* THIS PROGRAM IS A TRAINING PROGRAM TEST PER BRANCH
000900*      WITH A LINK TO TSUBR14
001000*
001100*      AND COPYLIBS   TCPYA14   (HEADER)
001200*                     TCPYB14   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'TSUBR14' USING PASS-ME-AROUND.
009000
...
013700     CALL 'TSUBR14' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TSUBR14' USING PASS-ME-AROUND.
