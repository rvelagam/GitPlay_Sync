...
000900*      WITH A LINK TO TSUBR24
001000*
001100*      AND COPYLIBS   TCPYA24   (HEADER)
001200*                     TCPYB24   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'TSUBR24' USING PASS-ME-AROUND.
009000
...
013700     CALL 'TSUBR24' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TSUBR24' USING PASS-ME-AROUND.
