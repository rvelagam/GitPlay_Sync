...
000900*      WITH A LINK TO KEESUB1
001000*
001100*      AND COPYLIBS   KEECPYA1   (HEADER)
001200*                     KEECPYB1   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'KEESUB1' USING PASS-ME-AROUND.
009000
...
013700     CALL 'KEESUB1' USING PASS-ME-AROUND.
013800
...
014400        CALL 'KEESUB1' USING PASS-ME-AROUND.
