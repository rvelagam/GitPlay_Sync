700010 IDENTIFICATION DIVISION.
000200 PROGRAM-ID.    TPROG12.
000300 AUTHOR.        COMPUWARE ISPW TRAINING.
000400 DATE-WRITTEN.  JANUARY 24TH, 1996-6-6-6.
000500 DATE-COMPILED.
000600
000700********************************************************
000800* THIS PROGRAM IS A TRAINING PROGRAM SYNC AZURE
000900*      WITH A LINK TO TSUBR12
001000*
001100*      AND COPYLIBS   TCPYA12   (HEADER)
001200*                     TCPYB12   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'TSUBR12' USING PASS-ME-AROUND.
009000
...
013700     CALL 'TSUBR12' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TSUBR12' USING PASS-ME-AROUND.
