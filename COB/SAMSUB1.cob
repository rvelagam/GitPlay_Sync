...
000900*      WITH A LINK TO SAMSUB2
001000*
001100*      AND COPYLIBS   SAMCPYA2   (HEADER)
001200*                     SAMCPYB2   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'SAMSUB2' USING PASS-ME-AROUND.
009000
...
013700     CALL 'SAMSUB2' USING PASS-ME-AROUND.
013800
...
014400        CALL 'SAMSUB2' USING PASS-ME-AROUND.
