...
000900*      WITH A LINK TO SAMSUB1
001000*
001100*      AND COPYLIBS   SAMCPYA1   (HEADER)
001200*                     SAMCPYB1   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'SAMSUB1' USING PASS-ME-AROUND.
009000
...
013700     CALL 'SAMSUB1' USING PASS-ME-AROUND.
013800
...
014400        CALL 'SAMSUB1' USING PASS-ME-AROUND.
