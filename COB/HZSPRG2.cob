...
000900*      WITH A LINK TO HZSSUB1
001000*
001100*      AND COPYLIBS   HZSCPYA1   (HEADER)
001200*                     HZSCPYB1   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'HZSSUB1' USING PASS-ME-AROUND.
009000
...
013700     CALL 'HZSSUB1' USING PASS-ME-AROUND.
013800
...
014400        CALL 'HZSSUB1' USING PASS-ME-AROUND.
