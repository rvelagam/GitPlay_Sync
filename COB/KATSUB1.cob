000100 IDENTIFICATION DIVISION.1
000200 PROGRAM-ID.    KATPRG2.
000300 AUTHOR.        COMPUWARE ISPW TRAINING.
000400 DATE-WRITTEN.  JANUARY 24TH, 1996.2
...
000900*      WITH A LINK TO KATSUB2
001000*
001100*      AND COPYLIBS   KATCPYA2   (HEADER)
001200*                     KATCPYB2   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'KATSUB2' USING PASS-ME-AROUND.
009000
...
013700     CALL 'KATSUB2' USING PASS-ME-AROUND.
013800
...
014400        CALL 'KATSUB2' USING PASS-ME-AROUND.
