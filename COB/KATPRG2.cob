...
001000*
001100*      AND COPYLIBS   KATCPYA1   (HEADER)
001200*                     KATCPYB1   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'KATSUB1' USING PASS-ME-AROUND.
009000
...
013700     CALL 'KATSUB1' USING PASS-ME-AROUND.
013800
...
014400        CALL 'KATSUB1' USING PASS-ME-AROUND.
