...
000900*      WITH A LINK TO TSUBR25
001000*
001100*      AND COPYLIBS   TCPYA25   (HEADER)
001200*                     TCPYB25   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'TSUBR25' USING PASS-ME-AROUND.
009000
...
013700     CALL 'TSUBR25' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TSUBR25' USING PASS-ME-AROUND.
